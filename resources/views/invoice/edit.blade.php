        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('invoice.index') }}" class="btn btn-sm btn-danger">Back</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="no_invoice" value="{{ $invoice->no_invoice }}" readonly class="form-control" id="no_invoice">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">No PO</label>
                                    <input type="text" name="no_po" class="form-control" value="{{ $invoice->no_po }}" id=""
                                        placeholder="Masukkan No. PO">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Date</label>
                                    <input type="date" name="tanggal" class="form-control" value="{{ $invoice->tanggal }}" id=""
                                        placeholder="Masukkan Tanggal">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Term</label>
                                    <input type="text" name="term" class="form-control" value="{{ $invoice->term }}" id=""
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_perusahaan" class="form-control" value="{{ $invoice->nama_perusahaan }}" placeholder="Masukkan Nama Customer">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Address</label>
                                    <input type="text" name="alamat" class="form-control" value="{{ $invoice->alamat }}" placeholder="Masukkan Alamat">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">No Telp</label>
                                    <input type="text" name="no_telp" class="form-control" value="{{ $invoice->no_telp }}" placeholder="Masukkan No. Telp">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>
                                                <input type="text" name="produk" class="form-control" placeholder="Masukkan Nama Barang" value="{{ $invoice->produk }}"><br>
                                                <input type="text" name="nama_kapal" class="form-control" placeholder="Masukkan Nama Kapal/site" value="{{ $invoice->nama_kapal }}"><br>
                                                <input type="text" name="wilayah_pengisian" class="form-control" placeholder="Masukkan Lokasi Pengisian" value="{{ $invoice->wilayah_pengisian }}">
                                            </td>
                                            <td style="vertical-align: top;">
                                                <input type="text" name="qty" class="form-control" placeholder="Masukkan Jumlah Barang" value="{{ $invoice->qty }}">
                                            </td>
                                            <td style="vertical-align: top;">
                                                <input type="text" name="satuan" class="form-control" placeholder="Masukkan Satuan Barang" value="{{ $invoice->satuan }}">
                                            </td>
                                            <td style="vertical-align: top;">
                                                <input type="text" name="harga_dasar" class="form-control" placeholder="Masukkan Harga Satuan" id="harga_dasar" value="{{ $invoice->harga_dasar }}"><br>
